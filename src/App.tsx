...
const projects = [
  ...
  },
  {
    ...
    href: 'https://github.com/colekenn/async-job-queue',
    visual: 'queue',
  },
  {
    number: '03',
...
const skills = [
  ...
  ['Frameworks', 'React · Electron · FastAPI · Flask · Tailwind CSS'],
  [
    'Technologies',
    'gRPC · Protobuf · PostgreSQL · Supabase · Redis · Docker · Git · Linux · AWS Cognito',
  ],
];
  ...
  useEffect(() => {
    const targets = [
      ...document.querySelectorAll<HTMLElement>(
        'main section:not(.hero) .section-label, main section:not(.hero) h2, .school-strip, .about-lead p, .stats > div, .honors, .coursework, .project-card, .text-link, .experience-list article, .skill-row, .contact-copy, .contact-links > a',
      ),
    ];
    ...
    <div className="site-shell">
      <header className={scrolled ? 'nav scrolled' : 'nav'}>
        ...
        >
          ...
          <a className="nav-contact" href="mailto:colekennedy56@gmail.com">
      ...
      <main id="top">
        <section className="hero section">
          ...
          <div className="hero-layout">
            <div className="hero-intro">
              <p className="intro-line intro-one">Hi, I’m</p>
              <h1 className="intro-line intro-two hero-title" aria-label="Cole Kennedy">
                <span className="name-line">
                  <span>Cole</span>
                </span>
                <span className="name-line">
                  <span>
                    Kennedy<span className="period">.</span>
                  </span>
                </span>
              </h1>
              <p className="hero-role intro-line intro-three">
                Aspiring software engineer<span className="cursor" aria-hidden="true" />
              </p>
              <p className="hero-description intro-line intro-four">
                Computer Science at the University of South Carolina. Interested in full-stack and systems engineering.
              </p>
            ...
            <figure className="hero-photo intro-line intro-three" aria-label="Portrait of Cole Kennedy">
              <div className="photo-frame">
                <img src="/cole-portrait.jpg" alt="Cole Kennedy" />
              </div>
            </figure>
          </div>

          <div className="hero-meta intro-line intro-five">
            <span>Graduating December 2027</span>
            <span>3.93 GPA</span>
          </div>
        </section>

        <aside className="school-strip" aria-label="Education">
          <a href="https://sc.edu" target="_blank" rel="noreferrer">
            <img src="/usc-logo.svg" alt="University of South Carolina logo" />
          </a>
        ...
        <section id="about" className="section split-section">
          ...
          <div className="about-content">
            <div className="about-lead">
              <div>
                <h2>CS student building full-stack products and systems software.</h2>
                <p>
                  I’m studying at the University of South Carolina with experience across product engineering, hardware-connected workflows, and peer instruction.
                </p>
              </div>
            </div>
            ...
            <div className="stats">
              ...
              <div>
                <strong>3×</strong>
                <span>President’s Honor List</span>
              </div>
              <div>
                <strong>2027</strong>
            ...
            <div className="honors">
              Academic Scholar — Distinction Award <span>·</span> Capstone Scholar <span />
            </div>

            <div className="coursework">
              <span>Coursework</span>
              Data Structures &amp; Algorithms · Operating Systems · Software Engineering · Computer Architecture · Advanced C++ · UNIX/Linux
            </div>
          </div>
        </section>
          ...
          <div className="experience-list">
            {experience.map((item, index) => (
              <article key={item.company + item.role}>
                ...
                <span className="experience-type">{item.period}</span>
              </article>
            ))}
          </div>
        </section>
        ...
        <section id="projects" className="section projects-section">
          ...
          <a className="text-link" href="https://github.com/colekenn" target="_blank" rel="noreferrer">
            More on GitHub <ArrowUpRight size={16} />
          </a>
        </section>

        <section id="skills" className="section split-section skills-section">
          <Label n="04" text="Skills" />
        ...
        <section id="contact" className="section contact-section">
          ...
          <h2>
            Connect <em>with me.</em>
          </h2>
          <p className="contact-copy">
            Email me directly, or find my work and background through GitHub and LinkedIn.
          </p>

          <div className="contact-links">
            <a href="mailto:colekennedy56@gmail.com">
              <Mail size={20} />
              <span>
                <small>Email</small>colekennedy56@gmail.com
              </span>
              <ArrowUpRight size={18} />
            </a>
            <a href="https://github.com/colekenn" target="_blank" rel="noreferrer">
              <GitHubIcon />
              <span>
                <small>GitHub</small>github.com/colekenn
              </span>
              <ArrowUpRight size={18} />
            </a>
            <a href="https://linkedin.com/in/coleken" target="_blank" rel="noreferrer">
              <LinkedInIcon />
              <span>
                <small>LinkedIn</small>linkedin.com/in/coleken
              </span>
              <ArrowUpRight size={18} />
            </a>
          </div>
      ...
      <footer>
        <span>© {new Date().getFullYear()} Cole Kennedy</span>
        <div className="socials">
          <a href="https://github.com/colekenn" target="_blank" rel="noreferrer" aria-label="GitHub">
            <GitHubIcon />
          </a>
          <a href="https://linkedin.com/in/coleken" target="_blank" rel="noreferrer" aria-label="LinkedIn">
            <LinkedInIcon />
          </a>
          <a href="mailto:colekennedy56@gmail.com" aria-label="Email">
            <Mail size={18} />
          </a>
        </div>
        <a href="#top">
          Back to top <ArrowDown className="up-arrow" size={16} />
        </a>
      </footer>
    </div>
  );
